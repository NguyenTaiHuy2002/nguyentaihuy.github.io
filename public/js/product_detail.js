                    ...
                    a =
                        (i("0H4L"),
                        {
                            ...
                            submitCaptcha: function() {
                                t(".js-submit-captcha").on("click", function(
                                    e
                                ) {
                                    e.preventDefault();
            ...
            var s = i("hUol"),
                ...
                o = {
                    ...
                    replyComment: function() {
                        t("body").on("click", ".js-reply-comment", function(e) {
                            e.preventDefault();
                            var i = t(this),
                                s = i.closest("form"),
                                n = i.closest(".item"),
                    ...
                    showFormReply: function() {
                        var e = this;
                        t("body").on("click", ".js-show-form-reply", function(
                            i
                        ) {
                            i.preventDefault();
                            var s = t(this);
