        ...
        <div class="box box-warning">
            ...
            <div class="box-body">
                <div class="form-group ">
                    ...
                    <input type="text" class="form-control" name="pro_name" placeholder="Name ...." autocomplete="off"
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="pro_price"
                                ...
                                class="form-control" data-type="currency" placeholder="price...">
    ...
    <div class="col-sm-4">
        <div class="box box-warning">
            ...
            <div class="box-body block-images">
                ...
                @endif
                <div style="position:relative; margin-top: 10px"> <a class="btn btn-primary" href="javascript:;"> Choose
                        File... <input type="file"
                            style="position:absolute;z-index:2;top:0;left:0;filter: alpha(opacity=0);-ms-filter:&quot;progid:DXImageTransform.Microsoft.Alpha(Opacity=0)&quot;;opacity:0;background-color:transparent;color:transparent;"
                            name="pro_avatar" size="40" class="js-upload"> </a> &nbsp; <span class="label label-info"
                        id="upload-file-info"></span> </div>
            </div>
        </div>
    </div>
    <div class="col-sm-12 clearfix">
        <div class="box-footer text-center">
            <a href="{{ route('admin.product.index') }}" class="btn btn-default"><i class="fa fa-arrow-left"></i>
                Cancel</a>
