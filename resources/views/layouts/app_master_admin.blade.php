...
<body class="hold-transition skin-blue sidebar-mini">
    ...
    <div class="wrapper">
        <header class="main-header">
            <!-- Logo -->
            <div class="logo">
                <a href="/api-admin" class="desktop">
                    <img src="{{ url('images/logo.png') }}" style="height: 42px;" alt="Home">
                </a>
            </div>
        ...
        <aside class="main-sidebar">
            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    @endforeach
                    <!-- <li><a href="{{  route('xemdonhang') }}"><i class="fa fa-circle-o text-red"></i> <span>Đơn
                                hàng</span></a></li> -->
                    <!-- <li><a href="{{  route('admin.slide.index') }}"><i class="fa fa-circle-o text-red"></i>
                            <span>Quản lý slide</span></a></li>
                    <li><a href="{{  route('admin.event.index') }}"><i class="fa fa-circle-o text-red"></i>
                            <span>QUản lý sự kiện</span></a>
                    </li> -->
                    <!-- <li><a href="{{  route('admin.static.index') }}"><i class="fa fa-circle-o text-red"></i> <span>Trang
                                tĩnh</span></a></li> -->
                    <!-- <li><a href="{{  route('admin.statistical') }}"><i class="fa fa-circle-o text-red"></i> <span>Thống
                                kê</span></a></li> -->
                </ul>
            </section>
            <!-- /.sidebar -->
