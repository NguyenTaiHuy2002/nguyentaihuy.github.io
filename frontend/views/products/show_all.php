                        ...
                        <div class="content-product-list products-resize">
                            <div class="product-list-view row  grid  products-grid">
                                ...
                                foreach ($products as $product):
                                    ...
                                    <div
                                        class="ajax_block_product col-xs-12 col-sm-6 col-md-4 col-lg-4 wow fadeInUp animation rainbow_0">
                                        <div class="product-item product-resize clearfix">

                                            <div class="left-block product-img image-resize"
                                                style="background-image: url(../backend/assets/uploads/<?php echo $product['avatar']; ?>);">

                                                <!-- <a href="<?php echo $product_link; ?>"
                                                    title="<?php echo $product['title']; ?> - <?php echo $product['weight']; ?>">
                                                    <img alt=" <?php echo $product['title']; ?> - <?php echo $product['weight']; ?> "
                                                        src="../backend/assets/uploads/<?php echo $product['avatar']; ?>" />
                                                </a> -->
                                                <a href="<?php echo $product_link; ?>" class="mask-brg"></a>
                                                <div class="hover-mask">
                                                    <div class="inner-mask">
                                                        <a class="add-view-cart btn-cart add-cart "
                                                            data-variant="1007783469"
                                                            href="them-vao-gio-hang/<?php echo $product['id']; ?>"
                                                            title="Thêm vào giỏ">
                                                        ...
                                                        <ul class="add-to-links">
                                                            <li><a href="<?php echo $product_link; ?>" class="mask-view"
                                                                    data-handle="/products/xa-lach-romaine-dl"
                                                                    title="Xem nhanh"><i class="fa fa-eye"></i></a></li>
                                                            <li><a href="<?php echo $product_link; ?>" class=""
                                                                    title="Xem chi tiết"><i class="fa fa-search"></i></a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
            ...
            <form action="" method="post" <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 pull-left">
                ...
                <div class="sidebar_price list-group">
                    ...
                    <ul class="nav navs sidebar menu" id='cssmenu'>
                        ...
                        <li class="item  first">
                            <a>
                                <input type="checkbox" name="price[]" value="1" <?php echo $checked_price1; ?>> Dưới
                                500,000
                            </a>
                        </li>
                        <li class="item">
                            <a>
                                <input type="checkbox" name="price[]" value="2" <?php echo $checked_price2; ?>> 500,000
                                - 1,000,000
                            </a>
                        </li>
                        <li class="item">
                        ...
                        <li class="item  last">
                            <a>
                                <input type="checkbox" name="price[]" value="5" <?php echo $checked_price5; ?>> Trên
                                10,000,000
                            </a>
                        </li>
                    </ul>
