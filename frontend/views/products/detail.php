                        ...
                        <div id="surround">
                            <div class="white-product">
                                ...
                                <img class="product-image-feature"
                                    ...
                                    alt="<?php echo $product['title']; ?> - <?php echo $product['weight']; ?>">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                        ...
                        <form id="add-item-form" action="https://growmax.myharavan.com/cart/add" method="post"
                                        ...
                                        <div class="box-add-cart">
                                            <a href="them-vao-gio-hang/<?php echo $product['id']; ?>">
                                                <button type="button" id="add-to-cart"
                                                    class=" btn-detail addtocart btn-color-add btn-min-width btn-mgt"
                                                    name="add">
                                                    Thêm vào giỏ
                                                </button>
                                            </a>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-top:20px;">
                        <div role="tabpanel" class="product-comment">
                            ...
                            <ul class="nav nav-tabs" id="page-product" role="tablist">
                                <li role="presentation"><a href="#mota" aria-controls="mota" role="tab"
                                        data-toggle="tab">Mô tả sản phẩm</a></li>

                                <li role="presentation">
                                    <a href="#binhluan" aria-controls="binhluan" role="tab" data-toggle="tab"
                                ...
                                <div role="tabpanel" class="tab-pane active" id="binhluan">
                                    <div class="container-fluid product-comment-wrapper">
                                        ...
                                        <div class="fb-comments"
                                            data-href="https://growmax.myharavan.com/products/bap-cai-tim"
